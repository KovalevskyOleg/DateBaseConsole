...
namespace HelloApp
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string connectionString = "Server = sql.bsite.net\\MSSQL2016; Database = samurai_Black; User Id = samurai_Black; Password = Neon;TrustServerCertificate=true";
            ...
            string sqlExpression = "SELECT * FROM Users";
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    if (a == 2)
                    {
                        ...
                        string addUsers = $"INSERT INTO Users (firstname, age, username, password) VALUES ('{name}', {age}, '{username}', '{password}')";
                    ...
                    if (a == 3)
                    {
                        ...
                        if (Choose == 1)
                        {
                            ...
                            string name = (Console.ReadLine());
                            string updateUsers = $"UPDATE Users SET firstname='{name}' WHERE Id='{Up}'";
                        ...
                        if (Choose == 2)
                        {
                            ...
                            string username = (Console.ReadLine());
                            string updateUsers = $"UPDATE Users SET username='{username}' WHERE Id='{Up}'";
                        ...
                        if (Choose == 3)
                        {
                            ...
                            int age = Convert.ToInt32(Console.ReadLine());
                            string updateUsers = $"UPDATE Users SET age='{age}' WHERE Id='{Up}'";
                    ...
                    if (a == 5)
                    {
                        ...
                        string usName1 = Console.ReadLine();
                        Console.WriteLine("Введите Пароль");
                        string password1 = Console.ReadLine();
                        string select = $"SELECT * FROM Users WHERE username='{usName1}' password='{password1}'";
